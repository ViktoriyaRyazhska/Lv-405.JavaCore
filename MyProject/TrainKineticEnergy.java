...
//		Integer.parseInt(br.readLine())
		...
		int[] Ftjaga = { 40000, 32800, 27800, 21400, 17400, 14600, 12400, 10600 };// силя тяги локомотива 2М62 в межах
																					// 20-90 км/год
		double Ft = 0, Fn, Fk, wo1, wo2, fk, wo, S = 0, St; // силя тяги при середній швидкості, силя таги при маким.
...
//				System.out.println("25-20 Fn:" + Fn + ", Fk:" + Fk + ", Ft:" + Ft);
			...
			S = S + St;
			if (Vaver >= 20) {
				System.out.println("row-" + s + " | " + Vk + " | " + Vaver + " | " + df.format(wo1) + " | "
	...
	public static double task2() throws NumberFormatException, IOException {
		...
		String [] locomotive = {"ВЛ11/ВЛ10", "ВЛ80", "ВЛ40", "2М62", "М62", "2ТЕ10м", "М62м", "ТЕ33АС", "ЧМЕ3" };// назва локомотиву
		int [] Ftjaga1 = {62000, 69000, 34000, 72000, 36000, 81300, 40000, 51200, 36000};// сила тяги локомотива при рушанні з місця, кгс
		int [] Ftjaga2 = {46000, 51200, 25600, 40000, 20000, 48000, 32000, 43540, 23000};// критична сила тяги локомотива, кгс
